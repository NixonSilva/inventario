...
const MessageModal = ({
  ...
  return (
    <Modal show={show} onHide={handleClose} centered className="rounded-modal" backdrop="static" keyboard={false}>
      ...
      <Modal.Body className="modal-body text-center ">
        ...
        {showTextInput && (
          <Form.Group className="mt-3 text-start textoModal ">
            <Form.Label>{textInputLabel}{textInputRequired && <span className="text-danger"> </span>}</Form.Label>
            <Form.Control
              as="input"
              rows={3}
