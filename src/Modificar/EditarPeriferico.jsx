...
const API_URL = "https://inventario.navesoft.com/backend/backend/actualizarPeriferico.php";
const CONSULTA_API = "https://inventario.navesoft.com/backend/backend/obtenerPeriferico.php";
